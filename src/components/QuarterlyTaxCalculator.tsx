          ...
          <div className="space-y-4">
            ...
            <div className="text-center p-6 bg-slate-900/50 rounded-lg">
              <div className="text-5xl font-black text-white mb-2">
                ${taxCalc.totalTaxLiability.toLocaleString()}
              </div>
              <div className="text-sm text-slate-400">Total Estimated Tax</div>
              <div className="text-xs text-slate-500 mt-1">
                Effective rate: {(taxCalc.effectiveTaxRate * 100).toFixed(1)}%
              </div>
            </div>
          ...
          <div className="space-y-3">
            {quarterPayments.map((quarter) => {
              ...
              return (
                <div
                  key={quarter.quarter}
                  className={`p-4 rounded-lg border ${statusColors[quarter.status as 'due' | 'upcoming' | 'future']}`}
                >
