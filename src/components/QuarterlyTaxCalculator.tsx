    ...
    <div className="space-y-4">
        ...
        <CardContent className="space-y-3">
          <div className="grid md:grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <Label htmlFor="income" className="text-slate-400 text-xs">
                Year-to-Date Income
              </Label>
            ...
            <div className="space-y-1.5">
              <Label htmlFor="expenses" className="text-slate-400 text-xs">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <Card className="border-white/10 shadow-none">
          ...
          <CardContent className="space-y-3">
            <div className="text-center p-3 bg-slate-950 rounded-md border border-white/10">
            ...
            <div className="space-y-1.5 text-xs">
              <div className="flex justify-between items-center p-2 bg-slate-950 rounded">
                ...
                <span className="text-white font-medium">${taxCalc.selfEmploymentTax.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
              </div>
              <div className="flex justify-between items-center p-2 bg-slate-950 rounded">
                <span className="text-slate-400">Federal Income</span>
                <span className="text-white font-medium">${taxCalc.federalIncomeTax.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
              </div>
              <div className="flex justify-between items-center p-2 bg-slate-950 rounded">
                <span className="text-slate-400">State Tax</span>
                <span className="text-white font-medium">${taxCalc.stateTax.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-white/10 shadow-none">
          ...
          <CardContent className="space-y-3">
            <div className="p-3 bg-slate-950 rounded-md border border-white/10">
      ...
      <Card className="border-white/10 shadow-none">
        ...
        <CardContent>
          <div className="space-y-2">
            {quarterPayments.map((quarter) => {
              const statusColors: Record<'due' | 'upcoming' | 'future', string> = {
                ...
                upcoming: "border-indigo-500/30 bg-indigo-500/10/60",
                future: "border-white/10 bg-slate-950",
              };

              const statusIcons: Record<'due' | 'upcoming' | 'future', React.ReactNode> = {
                due: <AlertCircle className="w-4 h-4 text-red-400" />,
                upcoming: <Calendar className="w-4 h-4 text-indigo-400" />,
          ...
          <div className="mt-4 p-3 bg-slate-950 border border-white/10 rounded-md">
            <p className="text-xs text-slate-300 mb-1.5 font-semibold">Payment instructions</p>
            <ul className="text-xs text-slate-400 space-y-0.5">
              <li>• Pay at <a href="https://www.irs.gov/payments" target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:underline">IRS.gov/payments</a></li>
