		...
		<div className="min-h-screen bg-white font-inter text-gray-900">
			...
			<section className="pt-16 pb-16 px-6 relative overflow-hidden">
				<div className="absolute inset-0">
					<div className="absolute top-20 left-20 w-72 h-72 bg-blue-400/30 rounded-full mix-blend-multiply filter blur-3xl animate-blob" />
					<div className="absolute top-40 right-20 w-72 h-72 bg-purple-400/30 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000" />
					<div className="absolute -bottom-20 left-1/2 w-72 h-72 bg-pink-400/30 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-4000" />
				</div>

				<div className="max-w-6xl mx-auto relative z-10">
					<div className="text-center max-w-3xl mx-auto">
						<div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 backdrop-blur-sm rounded-full border border-gray-200 mb-6">
						...
						<h1 className="text-5xl md:text-6xl font-bold mb-6 leading-[1.02] font-space-grotesk">
							<span className="inline-block bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 bg-clip-text text-transparent animate-gradient">
								Keep more
							</span>
							<br />
							<span className="text-gray-900">of what you earn.</span>
						</h1>
					...
					<div className="max-w-3xl mx-auto relative group">
						<div className="absolute inset-0 bg-gradient-to-r from-blue-400/30 via-purple-400/30 to-pink-400/30 rounded-3xl blur-xl opacity-70" />
						<div className="relative rounded-2xl border border-gray-200 bg-white shadow-xl overflow-hidden">
							<div className="px-5 py-3.5 border-b border-gray-100 flex items-center justify-between">
								...
								<span className="text-xs font-bold tabular-nums bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
									76 / 76 classified
								</span>
							</div>
							<div className="divide-y divide-gray-100 text-sm">
								<MockRow
									icon={<SiUber className="h-4 w-4 text-gray-500 shrink-0" />}
								...
								<MockRow
									icon={
										<SiDoordash className="h-4 w-4 text-gray-500 shrink-0" />
									}
							...
							<div className="px-5 py-4 bg-gray-50 flex flex-wrap gap-x-10 gap-y-3 items-center justify-between">
								<MockStat label="Deductions found" value="$2,593.74" grad="from-purple-600 to-pink-500" />
								<MockStat label="Set aside for Q3" value="$1,840" grad="from-blue-600 to-purple-600" />
								<MockStat label="Platforms detected" value="7" grad="from-pink-500 to-blue-600" />
							</div>
						</div>
					</div>
				</div>
						...
						{[...Array(2)].map((_, i) => (
							<div key={i} className="flex items-center gap-4 px-2">
								{PLATFORMS.map(({ icon: Icon, name }) => (
									<div
										key={name}
										className="flex items-center gap-2 bg-white border border-gray-200 rounded-full shadow-sm px-4 py-2 whitespace-nowrap"
									>
			...
			<section className="px-6 pb-24 relative overflow-hidden">
				<div className="absolute -bottom-24 left-1/3 w-72 h-72 bg-purple-300/30 rounded-full blur-3xl" />
				<div className="max-w-3xl mx-auto text-center relative z-10">
					<h2 className="text-3xl md:text-4xl font-bold mb-4 font-space-grotesk text-gray-900">
	...
	return (
		<div className="px-5 py-3 flex items-center justify-between gap-3">
			<div className="flex items-center gap-3 min-w-0">
				{icon ?? <span className="h-4 w-4 rounded-full bg-gray-300 shrink-0" />}
